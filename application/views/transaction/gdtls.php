<div class="wraper">
    ...
    <div class="col-md-6 container form-wraper">
        ...
        <form method="POST" id="product" action="<?php echo site_url("godown/godowndtls") ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="hidden" id=yr_sl name="yr_sl" class="form-control required"  />

                    <input type="text" id=yr_nm name="yr_nm" class="form-control required"  />

                </div>
                </div>
                <div class="form-group row">
                <label for="mnth" class="col-sm-2 col-form-label">WareHouse Address:</label>
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                ...
                <select name="purp" class="form-control required" id="purp" style="width: 350px;">
            ...
            ?>
                ...
                <label for="purp" class="col-sm-2 col-form-label">Purpose:</label>
                <div class="col-sm-4">
            ...
            <div class="form-group row">
                <label for="onholdv" class="col-sm-2 col-form-label">Capacity:</label>
                <div class="col-sm-4">
                    <input type="text" id=onholdv name="onholdv" class="form-control required"  />
                ...
                <div class="col-sm-4">
                 ...
                 <select name="location" class="form-control required" id="location" style="width: 350px;">
            ...
            <div class="form-group row">
                <label for="onholdv" class="col-sm-2 col-form-label">Rent start sate:</label>
                <div class="col-sm-4">
                    <input type="date" id=onholdv name="onholdv" class="form-control required"  />

                </div>
                
            <!-- </div>
            <div class="form-group row"> -->
                <label for="onholdv" class="col-sm-2 col-form-label">Rent End date:</label>
                <div class="col-sm-4">
                    <input type="date" id=onholdv name="onholdv" class="form-control required"  />
            ...
            <!-- </div>
            <div class="form-group row"> -->
                <label for="onholdv" class="col-sm-2 col-form-label">rate:</label>
                <div class="col-sm-4">
                    <input type="text" id=onholdv name="onholdv" class="form-control required"  />
            ...
            <div class="form-group row">
                <label for="onholdv" class="col-sm-2 col-form-label">Monthly rent amount:</label>
                <div class="col-sm-10">
                    <input type="text" id=onholdv name="onholdv" class="form-control required"  />
            ...
            <div class="form-group row">
                <label for="onholdv" class="col-sm-2 col-form-label">To Whome:</label>
                <div class="col-sm-10">
                    <input type="text" id=onholdv name="onholdv" class="form-control required"  />
    ...
    <div class="col-md-5 container form-wraper" style="margin-left: 10px;">
        ...
        <form method="POST" id="product" action="<?php echo site_url("transaction/month_end") ?>">
            ...
            <div class="form-group row">
                ...
                <label for="yr" class="col-sm-2 col-form-label">File Name:</label>
                <div class="col-sm-4">

                    <input type="text" id="current_yr_nm" name="current_yr_nm" class="form-control required" readonly />

                </div>
                <label for="mnth" class="col-sm-2 col-form-label">Download:</label>
                <div class="col-sm-4">
