...
<body>
	<header class="headerTop_DashLogin">
		<div class="wrapper_Dash" onclick="location.href = 'https://benfed.in/benfed_godown/' ">
	...
	<div class="daseboardContentArea_DashLogin daseboardPading_DashLogin">
		<div class="wrapper_Dash">
			<div class="wrap-login100">
				<form class="login100-form validate-form flex-sb flex-w" id="login" method="POST" action="<?php echo site_url("godown_Login/index") ?>">
...
<!--===============================================================================================-->
 ...
 var user_id = $('#user_id').val();
  ...
  $.ajax({
  type: "POST",
  url: "<?php echo site_url("godown_Login/check_user") ?>",
