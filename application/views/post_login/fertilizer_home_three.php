      ...
      <div class="col-sm-3 float-left">
        <div class="left_bar_new">
          ...
          <ul>
            ...
            <li><a href="https://benfed.in/benfed_godown/index.php/trade/sale">Sale</a></li>
            <li><a href="https://benfed.in/benfed_godown/index.php/drcrnote/dr_note">Credit Note</a></li>
            <li><a href="https://benfed.in/benfed_godown/index.php/socpay/society_payment">Receive Payment</a></li>
            <li><a href="https://benfed.in/benfed_godown/index.php/socpay/soc_payment_fwd">Forward Payment</a></li>
            <li><a href="https://benfed.in/benfed_godown/index.php/fert/rep/stkStmt">Consolidated Stock</a></li>
            <li><a href="https://benfed.in/benfed_godown/index.php/fert/rep/stkSprod">Productwise Stock</a></li>
            <li><a href="https://benfed.in/benfed_godown/index.php/fert/rep/purrep">Purchase Ledger</a></li>
...
<script>
  ...
  $('#select_district').change(function() {
    ...
    $.ajax({
      url: "<?= site_url('godown_Login/societyWiseStatus') ?>",
      type: "POST",
      dataType: "json",
      data: {
        soc_id: soc_id
...
$("#company_dtls").click(function(){
  ...
  var br_id = '<?= $this->session->userdata['loggedin']['branch_id'] ?>';
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url("godown_Login/f_br_purchasec") ?>",
      data: {
        br_id: br_id,
        comp_id: comp_id,
      },
...
<script>
  ...
  function brdaypurchase(br_id) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url("godown_Login/f_br_purchase") ?>",
      data: {
        br_id: br_id
      },
  ...
  $(document).ready(function() {
    ...
    $('#district').change(function() {
      ...
      $.get(
        ...
        '<?php echo site_url("godown_Login/f_get_stkpnt"); ?>',
