...
<ul class="header_top">
    ...
    <li><strong>Module:</strong> godown Management</li>
...
<?php } ?> -->
        ...
        <nav class="navbar navbar-inverse bg-primary">
         ...
         <div class="col-sm-10 navbarSectio">
                    ...
                    <div class="dropdown">
                    <div class="dropbtn">
                    <a href="<?php echo site_url("godown_Login/main");?>" style="color: white; text-decoration: none;"><i class="fa fa-home"></i> Home</a>
                    </div> 
                    </div>
	...
	?>
                            ...
                            <div class="dropdown-content">
							   <?php if( $this->session->userdata['loggedin']['ho_flag']!="Y"){?>
                                ...
                                <!-- <div class="sub-dropdown">
								   ...
								   <div class="sub-dropdown-content">list
                    ...
                    <div class="dropdown">
                        <div class="dropbtn">
                            <a href="<?php echo site_url("godown_Login/logout") ?>" style="color: white; text-decoration: none;"><i class="fa fa-sign-out" aria-hidden="true"></i> Logout</a>
                        </div>    
                    </div>    
                   </div>
            </div>
