    <div class="wraper">      
      <div class="col-md-3"></div>
        <div class="col-md-6 container form-wraper">
            ...
            <form method="POST" id="form" action="<?php echo site_url("key/editlocation");?>" >
                ...
                <div class="form-group row">
                    ...
                    <label for="loc_name" class="col-sm-2 col-form-label">Name:</label>

                    <div class="col-sm-10">

                        <input type="text" name="loc_name" class="form-control required"  
                            value = "<?php echo $schdtls->loc_name; ?>" 
                        />
		            </div>
